# ============================================================
#  Shooserie - Action #3 - CORRECTIF #2
#  - Vrais noms de colonnes sneakers (name, photo_url, size_eu...)
#  - UTF-8 propre (fix du double-encodage des accents)
#  - Etat isError visible (au lieu de faux "Utilisateur introuvable")
# ============================================================

$ErrorActionPreference = "Stop"

# Helper d'ecriture UTF-8 sans BOM (cible Vite)
...
Write-Host ""
Write-Host "=== Shooserie - Action #3 (correctif #2) ===" -ForegroundColor Cyan
$currentBranch = ""
...
# ============================================================
# 1. src/lib/publicProfileQueries.ts
# ============================================================
$queriesFile = @'
...
# ============================================================
# 2. src/pages/UserProfile.tsx  (page complete reecrite)
# ============================================================
$pageFile = @'
/**
...
Write-Host "  ~  src/pages/UserProfile.tsx" -ForegroundColor Green

# ============================================================
# Verif rapide : pas de double-encodage dans les fichiers
# ============================================================
Write-Host ""
Write-Host "Verif accents (doit afficher des é/à/è propres) :" -ForegroundColor Cyan
$bytes = [System.IO.File]::ReadAllBytes((Join-Path (Get-Location).Path "src/pages/UserProfile.tsx"))
$utf8 = [System.Text.Encoding]::UTF8.GetString($bytes)
$badPattern = $utf8 | Select-String -Pattern "Ã©|Ã¨|Ã |Ã€" -AllMatches
if ($badPattern) {
    Write-Host "  ERREUR : double-encodage detecte dans UserProfile.tsx" -ForegroundColor Red
    Write-Host "          Verifie le script source, ne push pas." -ForegroundColor Red
} else {
    Write-Host "  OK : UserProfile.tsx en UTF-8 propre" -ForegroundColor Green
}

Write-Host ""
Write-Host "=== Correctif #2 applique ===" -ForegroundColor Cyan
Write-Host ""
Write-Host "Prochaines etapes :" -ForegroundColor Yellow
Write-Host "  npm run build"
Write-Host "  git add src/lib/publicProfileQueries.ts src/pages/UserProfile.tsx"
Write-Host "  git commit -m `"fix(profile): real sneakers schema (name/photo_url/size_eu) + UTF-8`""
Write-Host "  git push origin dev"
Write-Host ""
Write-Host "Une fois Vercel rebuilt, retest /u/Layon (en navigation privee + Ctrl+Shift+R)" -ForegroundColor Yellow
Write-Host ""
