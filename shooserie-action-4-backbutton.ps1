# ============================================================
#  Shooserie - AppHeader + BackButton sur Community et UserProfile
# ============================================================
...
Write-Host ""
Write-Host "=== Shooserie - AppHeader + BackButton ===" -ForegroundColor Cyan
$currentBranch = ""
...
# ============================================================
# 1. src/components/BackButton.tsx  (composant reutilisable)
# ============================================================
$backBtn = @'
/**
...
'@
Write-FileUtf8NoBom -Path "src/components/BackButton.tsx" -Content $backBtn
Write-Host "  +  src/components/BackButton.tsx" -ForegroundColor Green

# ============================================================
# 2. src/pages/Community.tsx  (reecrit avec AppHeader wrap)
# ============================================================
$communityPage = @'
/**
...
'@
Write-FileUtf8NoBom -Path "src/pages/Community.tsx" -Content $communityPage
Write-Host "  ~  src/pages/Community.tsx  (reecrit avec AppHeader wrap)" -ForegroundColor Green

# ============================================================
# 3. src/pages/UserProfile.tsx  (reecrit avec AppHeader wrap)
# ============================================================
$userProfilePage = @'
/**
...
'@
Write-FileUtf8NoBom -Path "src/pages/UserProfile.tsx" -Content $userProfilePage
Write-Host "  ~  src/pages/UserProfile.tsx  (reecrit avec AppHeader wrap)" -ForegroundColor Green

# ============================================================
# Verif anti-double-encodage
# ============================================================
Write-Host ""
Write-Host "Verif UTF-8 :" -ForegroundColor Cyan
foreach ($p in @("src/components/BackButton.tsx", "src/pages/Community.tsx", "src/pages/UserProfile.tsx")) {
...
Write-Host "  git add src/components/BackButton.tsx src/pages/Community.tsx src/pages/UserProfile.tsx"
Write-Host "  git commit -m `"feat(layout): AppHeader + BackButton on Community and UserProfile`""
